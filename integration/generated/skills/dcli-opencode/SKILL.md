---
name: dcli-opencode
description: Delegate bounded work to the opencode CLI as a different backend, running unattended. Use when wrapper job guarantees are needed.
---
...
- `--variant <string>` — provider-specific reasoning variant. `--effort` is rejected before a job is created.
