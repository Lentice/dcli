...
The initial implementation is complete. [`docs/tickets/`](docs/tickets/) is a live backlog; its README
table is generated from the ticket files by `scripts/generate-tickets-table.js`, so a ticket's status and
blockers live in its own file, not in the table.
...
| Editing a ticket's status, or the tracker table | [`docs/tickets/AUTHORING.md`](docs/tickets/AUTHORING.md) + [`TEMPLATE.md`](docs/tickets/TEMPLATE.md); the table is generated by [`scripts/generate-tickets-table.js`](scripts/generate-tickets-table.js) |
